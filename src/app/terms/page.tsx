    ...
    <div className="min-h-dvh bg-background text-foreground">
      ...
      <main id="main" className="flex flex-col mx-auto min-w-0 max-w-3xl gap-6 px-6 py-10 text-sm leading-relaxed text-foreground">
        ...
        <Section title="2. Not financial advice">
          ...
          assistant (&ldquo;Margus&rdquo;) or other AI features are
          informational only, not investment, financial, tax, or legal advice,
          and not a recommendation to buy, sell, or hold any security or to
          write any option contract. You are solely responsible for your own
          ...
          carry additional, specific risks. Consult a licensed professional
