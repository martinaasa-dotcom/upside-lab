...
function CommandDialog({
  ...
  return (
    <Dialog {...props}>
      ...
      >
        {/* Inside the content, where Radix ties the title to the dialog it
            names. Outside, it rendered into the page while the palette was
            closed, as stray text in no landmark. */}
