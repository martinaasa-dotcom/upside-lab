...
- Inbox notes (Sunday letter): two short paragraphs. What moved and why, in kitchen-table words. Name more than one ticker when more than one moved. Then the other big holdings: each was steady, up, or down. Name each cashtag at most once. Then stop. Vary the wording from letter to letter. Sometimes short and direct, sometimes a little warmer. Never name a mix percent. Never paste a headline as its own sentence. Finish every sentence. Never name a website, publisher, or paste a link.
